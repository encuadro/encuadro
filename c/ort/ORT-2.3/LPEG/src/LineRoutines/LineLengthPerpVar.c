...
Output result       : 
 ...
 LengthPerpVar	-- The variance in the length of the line

Calling procedure:

 double Length;

 Variance_in_length_of_my_bloody_line = LineLengthPerpVar();
...
#ifdef debug
          fprintf(stderr," Start of function LineLengthPerpVar \n");
#endif

	return(2.0);

#ifdef debug
          fprintf(stderr," End of function LineLengthPerpVar \n");
#endif
