function setup = renderMarkerSetup(camera,repo_path,output_path,pose_id,mode)
...
setup.img_path_template = ['pose_%02d/' sprintf('%dx%d/',camera.int.width,camera.int.height)];
