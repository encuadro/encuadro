...
#define VEC_PRINT_6(a)					\
{							\
double len;						\
VEC_LENGTH_6 (len, (a));				\
printf (#a " is %f %f %f %f %f %f length of " #a " is %f \n",	\
(a)[0], (a)[1], (a)[2], (a)[3], (a)[4], (a)[5], len);		\
}
...
#define TRANSPOSE_MATRIX_6X3(b,a)	\
{				\
(b)[0][0] = (a)[0][0];	\
(b)[0][1] = (a)[1][0];	\
(b)[0][2] = (a)[2][0];	\
...
#define ACCUM_SCALE_MATRIX_6X6(b,s,a)	\
{					\
(b)[0][0] += (s) * (a)[0][0];	\
(b)[0][1] += (s) * (a)[0][1];	\
(b)[0][2] += (s) * (a)[0][2];	\
...
#define MATRIX_PRODUCT_3X3x3X6(c,a,b)				\
{								\
(c)[0][0] = (a)[0][0]*(b)[0][0]+(a)[0][1]*(b)[1][0]+(a)[0][2]*(b)[2][0];\
(c)[0][1] = (a)[0][0]*(b)[0][1]+(a)[0][1]*(b)[1][1]+(a)[0][2]*(b)[2][1];\
(c)[0][2] = (a)[0][0]*(b)[0][2]+(a)[0][1]*(b)[1][2]+(a)[0][2]*(b)[2][2];\
(c)[0][3] = (a)[0][0]*(b)[0][3]+(a)[0][1]*(b)[1][3]+(a)[0][2]*(b)[2][3];\
(c)[0][4] = (a)[0][0]*(b)[0][4]+(a)[0][1]*(b)[1][4]+(a)[0][2]*(b)[2][4];\
(c)[0][5] = (a)[0][0]*(b)[0][5]+(a)[0][1]*(b)[1][5]+(a)[0][2]*(b)[2][5];\
\
(c)[1][0] = (a)[1][0]*(b)[0][0]+(a)[1][1]*(b)[1][0]+(a)[1][2]*(b)[2][0];\
(c)[1][1] = (a)[1][0]*(b)[0][1]+(a)[1][1]*(b)[1][1]+(a)[1][2]*(b)[2][1];\
(c)[1][2] = (a)[1][0]*(b)[0][2]+(a)[1][1]*(b)[1][2]+(a)[1][2]*(b)[2][2];\
(c)[1][3] = (a)[1][0]*(b)[0][3]+(a)[1][1]*(b)[1][3]+(a)[1][2]*(b)[2][3];\
(c)[1][4] = (a)[1][0]*(b)[0][4]+(a)[1][1]*(b)[1][4]+(a)[1][2]*(b)[2][4];\
(c)[1][5] = (a)[1][0]*(b)[0][5]+(a)[1][1]*(b)[1][5]+(a)[1][2]*(b)[2][5];\
\
(c)[2][0] = (a)[2][0]*(b)[0][0]+(a)[2][1]*(b)[1][0]+(a)[2][2]*(b)[2][0];\
(c)[2][1] = (a)[2][0]*(b)[0][1]+(a)[2][1]*(b)[1][1]+(a)[2][2]*(b)[2][1];\
(c)[2][2] = (a)[2][0]*(b)[0][2]+(a)[2][1]*(b)[1][2]+(a)[2][2]*(b)[2][2];\
(c)[2][3] = (a)[2][0]*(b)[0][3]+(a)[2][1]*(b)[1][3]+(a)[2][2]*(b)[2][3];\
(c)[2][4] = (a)[2][0]*(b)[0][4]+(a)[2][1]*(b)[1][4]+(a)[2][2]*(b)[2][4];\
(c)[2][5] = (a)[2][0]*(b)[0][5]+(a)[2][1]*(b)[1][5]+(a)[2][2]*(b)[2][5];\
}
...
#define MATRIX_PRODUCT_6X3x3X3(c,a,b)				\
{								\
(c)[0][0] = (a)[0][0]*(b)[0][0]+(a)[0][1]*(b)[1][0]+(a)[0][2]*(b)[2][0];\
(c)[0][1] = (a)[0][0]*(b)[0][1]+(a)[0][1]*(b)[1][1]+(a)[0][2]*(b)[2][1];\
(c)[0][2] = (a)[0][0]*(b)[0][2]+(a)[0][1]*(b)[1][2]+(a)[0][2]*(b)[2][2];\
...
(c)[2][2] = (a)[2][0]*(b)[0][2]+(a)[2][1]*(b)[1][2]+(a)[2][2]*(b)[2][2];\
\
(c)[3][0] = (a)[3][0]*(b)[0][0]+(a)[3][1]*(b)[1][0]+(a)[2][2]*(b)[2][0];\
(c)[3][1] = (a)[3][0]*(b)[0][1]+(a)[3][1]*(b)[1][1]+(a)[2][2]*(b)[2][1];\
(c)[3][2] = (a)[3][0]*(b)[0][2]+(a)[3][1]*(b)[1][2]+(a)[2][2]*(b)[2][2];\
\
(c)[4][0] = (a)[4][0]*(b)[0][0]+(a)[4][1]*(b)[1][0]+(a)[4][2]*(b)[2][0];\
(c)[4][1] = (a)[4][0]*(b)[0][1]+(a)[4][1]*(b)[1][1]+(a)[4][2]*(b)[2][1];\
(c)[4][2] = (a)[4][0]*(b)[0][2]+(a)[4][1]*(b)[1][2]+(a)[4][2]*(b)[2][2];\
\
(c)[5][0] = (a)[5][0]*(b)[0][0]+(a)[5][1]*(b)[1][0]+(a)[5][2]*(b)[2][0];\
(c)[5][1] = (a)[5][0]*(b)[0][1]+(a)[5][1]*(b)[1][1]+(a)[5][2]*(b)[2][1];\
(c)[5][2] = (a)[5][0]*(b)[0][2]+(a)[5][1]*(b)[1][2]+(a)[5][2]*(b)[2][2];\
}
...
#define MATRIX_PRODUCT_6X3x3X6(c,a,b)				\
{								\
(c)[0][0] = (a)[0][0]*(b)[0][0]+(a)[0][1]*(b)[1][0]+(a)[0][2]*(b)[2][0];\
(c)[0][1] = (a)[0][0]*(b)[0][1]+(a)[0][1]*(b)[1][1]+(a)[0][2]*(b)[2][1];\
(c)[0][2] = (a)[0][0]*(b)[0][2]+(a)[0][1]*(b)[1][2]+(a)[0][2]*(b)[2][2];\
...
(c)[3][1] = (a)[3][0]*(b)[0][1]+(a)[3][1]*(b)[1][1]+(a)[2][2]*(b)[2][1];\
(c)[3][2] = (a)[3][0]*(b)[0][2]+(a)[3][1]*(b)[1][2]+(a)[2][2]*(b)[2][2];\
(c)[3][3] = (a)[3][0]*(b)[0][3]+(a)[3][1]*(b)[1][3]+(a)[2][2]*(b)[2][3];\
(c)[3][4] = (a)[3][0]*(b)[0][4]+(a)[3][1]*(b)[1][4]+(a)[2][2]*(b)[2][4];\
(c)[3][5] = (a)[3][0]*(b)[0][5]+(a)[3][1]*(b)[1][5]+(a)[2][2]*(b)[2][5];\
\
(c)[4][0] = (a)[4][0]*(b)[0][0]+(a)[4][1]*(b)[1][0]+(a)[4][2]*(b)[2][0];\
(c)[4][1] = (a)[4][0]*(b)[0][1]+(a)[4][1]*(b)[1][1]+(a)[4][2]*(b)[2][1];\
(c)[4][2] = (a)[4][0]*(b)[0][2]+(a)[4][1]*(b)[1][2]+(a)[4][2]*(b)[2][2];\
(c)[4][3] = (a)[4][0]*(b)[0][3]+(a)[4][1]*(b)[1][3]+(a)[4][2]*(b)[2][3];\
(c)[4][4] = (a)[4][0]*(b)[0][4]+(a)[4][1]*(b)[1][4]+(a)[4][2]*(b)[2][4];\
(c)[4][5] = (a)[4][0]*(b)[0][5]+(a)[4][1]*(b)[1][5]+(a)[4][2]*(b)[2][5];\
\
(c)[5][0] = (a)[5][0]*(b)[0][0]+(a)[5][1]*(b)[1][0]+(a)[5][2]*(b)[2][0];\
(c)[5][1] = (a)[5][0]*(b)[0][1]+(a)[5][1]*(b)[1][1]+(a)[5][2]*(b)[2][1];\
(c)[5][2] = (a)[5][0]*(b)[0][2]+(a)[5][1]*(b)[1][2]+(a)[5][2]*(b)[2][2];\
(c)[5][3] = (a)[5][0]*(b)[0][3]+(a)[5][1]*(b)[1][3]+(a)[5][2]*(b)[2][3];\
(c)[5][4] = (a)[5][0]*(b)[0][4]+(a)[5][1]*(b)[1][4]+(a)[5][2]*(b)[2][4];\
(c)[5][5] = (a)[5][0]*(b)[0][5]+(a)[5][1]*(b)[1][5]+(a)[5][2]*(b)[2][5];\
}
...
#define MATRIX_PRODUCT_3X6x6X6(c,a,b)				\
{								\
...
#define MATRIX_PRODUCT_3X6x6X3(c,a,b)				\
{								\
(c)[0][0] = (a)[0][0]*(b)[0][0]+(a)[0][1]*(b)[1][0]+(a)[0][2]*(b)[2][0]+(a)[0][3]*(b)[3][0]+(a)[0][4]*(b)[4][0]+(a)[0][5]*(b)[5][0];\
(c)[0][1] = (a)[0][0]*(b)[0][1]+(a)[0][1]*(b)[1][1]+(a)[0][2]*(b)[2][1]+(a)[0][3]*(b)[3][1]+(a)[0][4]*(b)[4][1]+(a)[0][5]*(b)[5][1];\
(c)[0][2] = (a)[0][0]*(b)[0][2]+(a)[0][1]*(b)[1][2]+(a)[0][2]*(b)[2][2]+(a)[0][3]*(b)[3][2]+(a)[0][4]*(b)[4][2]+(a)[0][5]*(b)[5][2];\
...
#define MAT_DOT_VEC_6X3(p,m,v)					\
{								\
(p)[0] = (m)[0][0]*(v)[0] + (m)[0][1]*(v)[1] + (m)[0][2]*(v)[2];	\
(p)[1] = (m)[1][0]*(v)[0] + (m)[1][1]*(v)[1] + (m)[1][2]*(v)[2];	\
(p)[2] = (m)[2][0]*(v)[0] + (m)[2][1]*(v)[1] + (m)[2][2]*(v)[2];	\
(p)[3] = (m)[3][0]*(v)[0] + (m)[3][1]*(v)[1] + (m)[3][2]*(v)[2];	\
(p)[4] = (m)[4][0]*(v)[0] + (m)[4][1]*(v)[1] + (m)[4][2]*(v)[2];	\
(p)[5] = (m)[5][0]*(v)[0] + (m)[5][1]*(v)[1] + (m)[5][2]*(v)[2];	\
}
    
/* ========================================================== */
/* matrix times vector */
    
#define MAT_DOT_VEC_3X6(p,m,v)					\
{								\
(p)[0] = (m)[0][0]*(v)[0] + (m)[0][1]*(v)[1] + (m)[0][2]*(v)[2] + (m)[0][3]*(v)[3] + (m)[0][4]*(v)[4] + (m)[0][5]*(v)[5];	\
(p)[1] = (m)[1][0]*(v)[0] + (m)[1][1]*(v)[1] + (m)[1][2]*(v)[2] + (m)[1][3]*(v)[3] + (m)[1][4]*(v)[4] + (m)[1][5]*(v)[5];	\
(p)[2] = (m)[2][0]*(v)[0] + (m)[2][1]*(v)[1] + (m)[2][2]*(v)[2] + (m)[2][3]*(v)[3] + (m)[2][4]*(v)[4] + (m)[2][5]*(v)[5];	\
}
...
/* ========================================================== */
/* i,j,th cofactor of a 5x5 matrix
*
*/
    
#define COFACTOR_5X5_IJ(fac,m,i,j) 				\
{								\
int ii[5], jj[5], k,l,n,I,J;\
double auxMat[4][4];\
\
/* compute which row, columnt to skip */			\
for (k=0; k<(i); k++) ii[k] = k;				\
for (k=(i); k<4; k++) ii[k] = k+1;				\
for (k=0; k<(j); k++) jj[k] = k;				\
for (k=(j); k<4; k++) jj[k] = k+1;				\
for (l=0; l<4; l++){                            \
    for(n=0;n<4;n++){                           \
        I=ii[l];                                \
        J=jj[n];                                \
...
#define DETERMINANT_5X5(d,m)					\
{                                               \
double cofac;                                   \
COFACTOR_5X5_IJ (cofac, (m), 0, 0);				\
(d) = (m)[0][0] * cofac;					\
COFACTOR_5X5_IJ (cofac, (m), 0, 1);				\
(d) += (m)[0][1] * cofac;					\
COFACTOR_5X5_IJ (cofac, (m), 0, 2);				\
(d) += (m)[0][2] * cofac;					\
COFACTOR_5X5_IJ (cofac, (m), 0, 3);				\
(d) += (m)[0][3] * cofac;					\
COFACTOR_5X5_IJ (cofac, (m), 0, 4);				\
(d) += (m)[0][4] * cofac;					\
}
...
#define COFACTOR_6X6_IJ(fac,m,i,j) 				\
{								\
int ii[6], jj[6], k,l,n,I,J;\
double auxMat[5][5];\
\
/* compute which row, columnt to skip */			\
for (k=0; k<(i); k++) ii[k] = k;				\
for (k=(i); k<5; k++) ii[k] = k+1;				\
for (k=0; k<(j); k++) jj[k] = k;				\
for (k=(j); k<5; k++) jj[k] = k+1;				\
for (l=0; l<5; l++){                          \
    for(n=0;n<5;n++){                           \
        I=ii[l];                                \
        J=jj[n];                                \
...
#define DETERMINANT_6X6(d,m)					\
{                                               \
double cofac;                                   \
COFACTOR_6X6_IJ (cofac, (m), 0, 0);				\
(d) = (m)[0][0] * cofac;					\
COFACTOR_6X6_IJ (cofac, (m), 0, 1);				\
(d) += (m)[0][1] * cofac;					\
COFACTOR_6X6_IJ (cofac, (m), 0, 2);				\
(d) += (m)[0][2] * cofac;					\
COFACTOR_6X6_IJ (cofac, (m), 0, 3);				\
(d) += (m)[0][3] * cofac;					\
COFACTOR_6X6_IJ (cofac, (m), 0, 4);				\
(d) += (m)[0][4] * cofac;					\
COFACTOR_6X6_IJ (cofac, (m), 0, 5);				\
(d) += (m)[0][5] * cofac;					\
}
...
#define COFACTOR_5X5(a,m)                       \
{                                               \
    int i,j;                                        \
    \
    for (i=0; i<5; i++) {                           \
        for (j=0; j<5; j++) {                       \
            COFACTOR_5X5_IJ ((a)[i][j], (m), i, j); \
        }                                           \
    }                                               \
}
...
#define COFACTOR_6X6(a,m)                       \
{                                               \
    int i,j;                                        \
    \
    for (i=0; i<6; i++) {                           \
        for (j=0; j<6; j++) {                       \
            COFACTOR_6X6_IJ ((a)[i][j], (m), i, j); \
        }                                           \
    }                                               \
}
...
#define ADJOINT_5X5(a,m)					\
{								\
    int i,j;							\
    \
    for (i=0; i<5; i++) {					\
        for (j=0; j<5; j++) {					\
            COFACTOR_5X5_IJ ((a)[j][i], (m), i, j);		\
        }								\
    }								\
}
...
#define ADJOINT_6X6(a,m)					\
{								\
    int i,j;							\
    \
    for (i=0; i<6; i++) {					\
        for (j=0; j<6; j++) {					\
            COFACTOR_6X6_IJ ((a)[j][i], (m), i, j);		\
        }								\
    }								\
}
...
#define SCALE_ADJOINT_5X5(a,s,m)				\
{								\
    int i,j;							\
    \
    for (i=0; i<5; i++) {					\
...
#define SCALE_ADJOINT_6X6(a,s,m)				\
{								\
int i,j;							\
\
for (i=0; i<6; i++) {					\
...
#define INVERT_5X5(b,det,a)			\
{						\
double tmp;					\
DETERMINANT_5X5 ((det), (a));		\
tmp = 1.0 / (det);				\
SCALE_ADJOINT_5X5 ((b), tmp, (a));		\
}
...
#define INVERT_6X6(b,det,a)			\
{						\
double tmp;					\
DETERMINANT_6X6 ((det), (a));		\
tmp = 1.0 / (det);				\
SCALE_ADJOINT_6X6 ((b), tmp, (a));		\
}
