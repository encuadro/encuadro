...
double *punto3D1, *punto3D2, *punto3D3, *punto3D4, puntoModelo3D1[4] = {0,0,65/2,1}, puntoModelo3D2[4] = {-32.5,-32.5,65,1}, puntoModelo3D3[4] = {32.5,32.5,65,1}, puntoModelo3D4[4] = {0,0,65,1};
...
//        _cubito3.position = iv3(0,0,-1000);
        ...
        self.camera.position = iv3(60,-2,0.1);
...
//            _cubito3.position = iv3(punto3D3[1], -punto3D3[0], -punto3D3[2]);
            _redondel1.position = iv3(punto3D4[1], -punto3D4[0], -punto3D4[2]);
            _redondel2.position = iv3(punto3D2[1], -punto3D2[0], -punto3D2[2]);
            _redondel3.position = iv3(punto3D3[1], -punto3D3[0], -punto3D3[2]);
