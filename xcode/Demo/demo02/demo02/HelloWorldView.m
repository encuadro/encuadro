...
- (void) tick:(float)dt {
    ...
    if (self.traslacion !=nil)
    {
        //_cubito.rotationZ = self.rotacion[2];
      //  printf("%f \t %f\t %f\n",self.traslacion[0], self.traslacion[1], self.traslacion[2]);
        _cubito.position = iv3(self.traslacion[0]/10, -self.traslacion[1]/10, -self.traslacion[2]/20);
    }
    if (self.traslacion = nil)
    {
