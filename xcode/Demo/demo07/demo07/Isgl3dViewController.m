...
//  //  [theMovie.view setCenter:CGPointMake(fullScreenRect.size.width/2, fullScreenRect.size.height/2)];
//    [theMovie.view setBounds:fullScreenRect];
...
//    theMovie.view.frame=[[UIScreen mainScreen] bounds];
    ...
    NSLog(@"WIDTH ES: %f",fullScreenRect.size.width);
    NSLog(@"HEIGHT ES: %f",fullScreenRect.size.height);
...
- (void) procesarVideo{
    ...
    while (theMovie.playbackState==MPMoviePlaybackStatePlaying) {
        //accedo a pixeles
        
        //invoco procesamiento
