...
#import "demo01AppDelegate.h"
#import "Isgl3dViewController.h"
#import "Isgl3d.h"

@implementation demo01AppDelegate
...
- (void) applicationDidFinishLaunching:(UIApplication*)application {
    ...
    //vistaImg.image = [UIImage imageNamed:@"Calibrar10.jpg"];
    
    
    //vistaImg.transform =CGAffineTransformMake(0, 1, -1, 0, 0, 0);  
    /* Se ajusta la pantalla*/
    [vistaImg setCenter:CGPointMake(768/2, 1024/2)];    
    [vistaImg setBounds:CGRectMake(0,0,768, 1024)];
