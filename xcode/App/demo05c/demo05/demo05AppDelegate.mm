...
- (void) switchViews
{
    if (self.viewController == nil || self.viewController.view.superview == nil) {
        [self.vistaController.view removeFromSuperview];
...
//            [[Isgl3dDirector sharedInstance] addView:ui];
    ...
    } else 
    {
        ...
        [self.window addSubview:self.vistaController.view];
        [self.window bringSubviewToFront:self.vistaController.view];
    }
}
