//
//  renderiandoDinamicoAppDelegate.h
//  renderiandoDinamico
//
...
#import "renderiandoDinamicoAppDelegate.h"
#import "Isgl3dViewController.h"
#import "Isgl3d.h"


@implementation renderiandoDinamicoAppDelegate
...
- (void) applicationDidFinishLaunching:(UIApplication*)application {
    ...
    [vistaImg setBounds:CGRectMake(fullScreenRect.size.width/2, fullScreenRect.size.height/2, fullScreenRect.size.height, fullScreenRect.size.width)];
    ...
    _viewController.imagenView = vistaImg;
