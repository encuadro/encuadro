...
Entre todas las librerías que resuelven la decodificación, las librerías \textbf{ZXing} \cite{zxing} y \textbf{ZBar} \cite{zbar} son quizá las más destacadas, por su popularidad, simplicidad y buena documentación para la fácil implementación. ZXing, denominada así por ``Zebra Crossing'', es una librería gratis y en código abierto desarrollada en java y que tiene implementaciones que están adaptadas para otros lenguajes como C++, Objetive-C y JRuby, entre otros.
