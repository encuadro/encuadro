...
\newpage
\section{Herramientas de Hardware y Software de Apple Inc.}
\subsection{\textit{SoC}, CPU y GPU de plataformas Apple Inc.}
 \label{sec: SoC}
Uno de los puntos a evaluar de las plataformas de Apple Inc. es el \textbf{SoC}, que refiere a \textit{System on Chip} por sus siglas en inglés. \textit{System on Chip} es un concepto de los sistemas embebidos que refiere a la integración de todos los componentes de una computadora u otros sistemas electrónicos, en un solo circuito integrado. Básicamente, un \textit{SoC} y un microcontrolador cumplen funciones similares pero el \textit{SoC} forma parte de una evolución de los microcontroladores, siendo de una complejidad mayor e integrado en un tama\~no muy reducido buscando poco consumo y eficiencia de costos. Así entonces un \textit{SoC} puede estar conformado por un microcontrolador y hardware adicional como procesadores de se\~nal y bloques de memoria \cite{SoC}.  \\
...
$
\begin{array}{cc}
\includegraphics[scale=0.33]{figs_apend1/applea4.png} & \includegraphics[scale=0.3]{figs_apend1/applea5.png} \\
\end{array}
$
...
Por su parte todas las plataformas móviles de Apple Inc. corren otro sistema operativo de código cerrado: \textbf{iOS}. Originalmente llamado así por ser el utilizado por la plataforma \textit{iPhone}, este sistema operativo está también en las plataformas \textit{iPad}, \textit{iPod Touch} y \textit{Apple TV} en todas sus versiones. La versión más reciente de este SO es el iOS 6.1.
...
El SDK de iOS se puede clasificar en cuatro grandes capas según el nivel de abstracción: Cocoa Touch, Media, Core Services y Core OS como se muestra en la Figura \ref{fig: capas}.
\begin{figure}[h!]
\centering
\includegraphics[scale=0.3]{figs_apend1/iOSLayers.png}
\caption{Capas del SDK de iOS}
\label{fig: capas}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.6]{figs_apend1/mvc3.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.3]{figs_apend1/story.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.6]{figs_apend1/mrr.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.6]{figs_apend1/instrumentsWindow.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.6]{figs_apend1/instruments_tracing.png}
...
\newpage
\section{Herramientas de Productividad}
...
Para el presente proyecto comenzó utilizándose GoogleCode pero luego se decidió migrar todo el respositorio a Github por contar con mayores facilidades de gestión. Todo el código generado en este proyecto, así como la documentación es \textit{open source} y se puede bajar del repositorio git ubicado en: \url{https://github.com/encuadro/encuadro}.
