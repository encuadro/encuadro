...
El enfoque elegido para la validación de dichos algoritmos consiste en la generación de un conjunto de ``datos de referencia'' o \emph{ground truth} de forma de poder comparar la detección y resultados obtenidos con los valores reales o verdaderos de los mismos. Este proceso es lo que se denomina en este proyecto como \emph{Benchmark} o Comparativa. De esta forma se puede generar un número suficiente de datos de salida de forma de obtener algunas estadísticas de interés para la evaluación de los algoritmos.
...
\subsection{Generación de imágenes sintéticas: Blender}
...
\subsubsection{Ajustes de escena y parámetros: GUI}
...
\subsubsection{Ajustes de parámetros: Python scripting}
...
\subsubsection{Ejecución por consola de comandos}
...
Se generó un entorno de ejecución secuencial tipo batch en Matlab en donde se ejecuta Blender, en su modo de ejecución por consola de comandos con script de Python con argumentos , mediante el uso de la función de Matlab \texttt{system} la cual realiza una llamada al sistema.
