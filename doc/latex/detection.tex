...
\end{itemize}
La elección de estos parámetros fue \textbf{definitiva} para las pruebas de Benchamark a lo largo de todo el documento. Por más información sobre las herramientas de Benchmark y los parámetros ajustables para la generación de imágenes sintéticas referirse al Capítulo \ref{chap: benchmark}.
