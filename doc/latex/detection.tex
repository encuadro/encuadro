...
\begin{itemize}
 \item $width \times height$: Tamaño de imagen tomado $480x360$.
...
\begin{itemize}
 \item $d_{th} = 5px$
 \item $s = 0.5$
 \item $width\times height = 480x360 px^2$
\end{itemize}
