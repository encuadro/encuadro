...
El algoritmo consiste en cuatro etapas básicas las cuales se describen a continuación. A lo largo de estas etapas se ejemplifica mediante el uso del \emph{demo on-line} de Canny en IPOL\cite{ipol_canny} para la imagen de Lena. Estos resultados intermedio se encuentan en la Figura \ref{fig:resultado_canny_lena_inter}.
\begin{itemize}
