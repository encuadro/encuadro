...
\begin{eqnarray}
v_{j_{0}} = (a/2,a/2) && v_{j_{1}} = (a/2,-a/2)  \\
v_{j_{2}} = (-a/2,-a/2) && v_{j_{3}} = (-a/2,a/2)
\end{eqnarray}
...
El filtrado de segmentos consiste en una búsqueda de conjuntos de cuatro segmentos conexos en la lísta de segmentos de línea detectados por \emph{LSD}. A continuación se realiza una breve descripción del algoritmo de filtrado de segmentos implementado.\\
