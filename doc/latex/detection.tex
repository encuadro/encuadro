...
Los algoritmos desarrollados en el presente capítulo fueron implementados en Lenguaje C y están autocontenidos en el mismo código fuente sin la utilización de librerías externas para su funcionamiento.\\

La elección del lenguaje y la filosofía de desarrollo comentada atrás permite \textbf{portabilidad} en el uso de los mismos para aplicaciones más allá del proyecto y es un ejercicio de aprendizaje necesario. El algoritmo de filtrado y agrupamiento se implementó en los archivos \texttt{segments.c} y \texttt{segments.h} mientras que el de determinación de correspondencias se implementó en los archivos \texttt{marker.c} y \texttt{marker.h}.\\
...
Adicionalmente de forma de facilitar la tareas de interfaz como el abrir/capturar, el guardado/despliegue de imágenes o video así como el dibujado de segmentos y puntos sobre las imágenes se utiliza la librería OpenCV. Se aclara que esta interfaz no está de ninguna forma integrada con los algoritmos desarrollados pero fue de gran utilidad para la implementación de los mismos. Su utilización esta intrínsecamente ligada a la librería OpenCV pero esta es una muy popular librería multifplataforma para procesamiento de imágenes.

\section{Resultados de Benchmark}
En esta sección se presentan algunos resultados de \emph{Benchmark} para los algoritmos de asociados a la detección del marcador diseñado. En particular se estudian los límites para la detección de segmentos mediante LSD y el filtrado y agrupamiento de los mismos para juegos de imágenes sintéticas generadas utilizando las herramientas explicadas en el Capítulo \ref{chap: benchmark}.\\
...
\subsection{Elección de parámetros para Benchamark}
...
\end{itemize}
La elección de estos parámetros fue \textbf{definitiva} para las pruebas de Benchmark a lo largo de todo el documento. Por más información sobre las herramientas de Benchmark y los parámetros ajustables para la generación de imágenes sintéticas referirse al Capítulo \ref{chap: benchmark}.
