...
Sin embargo, los algoritmos desarrollados y utilizados en el proyecto para los módulos de detección de características, filtrado y agrupamiento de segmentos, determinación de correspondencias y estimación de pose; se encuentran escritos en lenguaje C y están autocontenidos en el mismo código fuente sin la utilización de librerías externas para su funcionamiento. Se hace énfasis en que estos módulos constituyen el núcleo de la solución al problema de realidad aumentada planteado inicialmente. \\
