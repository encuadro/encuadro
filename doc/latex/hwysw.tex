...
\section{Software}
Los algoritmos desarrollados y utilizados en el proyecto para los módulos de detección de características, filtrado y agrupamiento de segmentes, determinación de correspondencias y estimación de pose; se encuentran en Lenguaje C y están autocontenidos en el mismo código fuente sin la utilización de librerías externas para su funcionamiento. Se hace énfasis en que estos módulos constituyen el núcleo de la solución al problema de Realidad Aumentada planteado incialmente. La elección del lenguaje y la filosofía de desarrollo comentada anteriormente permite \textbf{portabilidad} en el uso de los mismos para aplicaciones más allá del proyecto y significó también un ejercicio de aprendizaje muy interesante. \\
...
\subsection{Sobre la implementación de los algoritmos}
