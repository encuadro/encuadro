...
Sin ir mas lejos, la implementación del algoritmo LSD utilizada en el presente proyecto, fue tomada de su publicación en IPOL, mientras que el autor de los artículos utilizados para la implementación del algoritmo de estimación de pose POSIT provee en su página el código fuente en C y en Matlab de algunas de las versiones del mismo.\\
