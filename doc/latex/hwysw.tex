...
Se explicaron algunas características generales de los sistemas operativos iOS y Mac OS X, así como también del lenguaje de programación Objective-C, superconjunto de C y que es el utilizado para desarrollar en los dispositivos mencionados. Se clasificaron distintos \textit{frameworks} dentro de iOS según los distintos niveles de abstracción, además se realizo una breve descripción de los más utilizados para esta aplicación en particular. También se vieron algunas herramientas que provee el entorno de desarrollo Xcode y otras herramientas que son comunes a cualquier proyecto de desarrollo de software como la utilización del software Git para el control de versiones.