...
Al trabajar con Apple se cuenta con la ventaja de contar con pocas variantes en cuanto al Hardware utilizado. Básicamente existen tres tipos de dispositivos en los que se pueden desarrollar: iPhone, iPad y iPod Touch. Para cada variante de plataforma existen distintos modelos que hacen que algunas características importantes como la capacidad de procesamiento, la resolución de cámara o el tama\~no de la pantalla entre otras puedan verse afectadas. A continuación se presenta brevemente cómo fue el surgimiento de cada uno de lo dispositivos al mercado y se describen resumidamente las principales características.
...
\normalsize
\textbf{SoC}
Una de las características comparadas es el \textbf{SoC} que significa \textit{System on Chip} por sus siglas en inglés.\\
explicar contraposici[on de system in package\\
\\
Apple A4, A5, A6 \\
\textbf{GPU}\\
SGX\\
Por qué motivos se eligieron esos dispositivos a comparar\\
