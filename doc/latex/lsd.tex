...
En el presente capítulo se estudiará a fondo el algoritmo y se presentarán y justificarán algunos cambios que hubo que hacerle a la imlpementación del mismo con la que se contaba, versión 1.6 descargada de \cite{IpolLsd12}, para mejorar su desempe\~no en el tiempo real.\\
