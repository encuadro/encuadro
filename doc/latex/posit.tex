...
\subsection{Notación y definición formal del problema de estimación de pose}
...
\end{equation}
El vector $Om_0$ es conocido ya que se conocen las coordenadas de los puntos $m_i$ y el factor de escala $s$ se obtiene de la norma de los vectores \textbf{I} o \textbf{J}.
