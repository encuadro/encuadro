...
\section{Resultados}
Se realizo un comparación entre la implementación en C de POSIT clásico para puntos coplanares, obtenida de la sitio web de \textit{Daniel DeMenthon} \footnote{\url{http://www.cfar.umd.edu/~daniel/Site_2/Code.html}}, y una version desarrollada para esta aplicación de POSIT moderno para puntos coplanares. 
