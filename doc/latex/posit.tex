...
\begin{figure}[H]
\centering
        \includegraphics[scale=0.5]{figs_posit/histAngulosPosit2}
        \label{fig:posit_8}
...
\label{fig:posit_9}
        \centering
        \subfigure[]{
                \includegraphics[scale=0.3]{figs_posit/barrido}
				\label{fig:posit_10}}
        \subfigure[]{
                \includegraphics[scale=0.3]{figs_posit/zoom}
                \label{fig:posit_11}}
...
\begin{figure}[H]
\centering
        \includegraphics[scale=0.5]{figs_posit/histTrasPosit2}
        \label{fig:posit_12}
...
\end{tabular}
\caption{Error de proyección de imágenes sintéticas.}
\label{posit_tabla2}
\end{table} 
...
En general se puede ver que el error de proyección y la varianza son un poco menores para el caso de POSIT coplanar moderno. 
