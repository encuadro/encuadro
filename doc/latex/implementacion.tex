...
\\
PONER FOTO DE AUTORTABLE ---CUADROTABLE
\\
...
\subsection{DrawSign}
\label{sec: drawsign}
Esta clase hereda de \textit{UIViewController} y está pensada para que el usuario pueda dibujar al tocar la pantalla. Se implementó haciendo una reimplementación de los siguientes tres métodos:
\begin{verbatim}
