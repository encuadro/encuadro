...
\end{verbatim}
 ...
 \item Asignación de nombre de imagen renderizada y ejecución de renderizado para guardar la imagen.
\begin{verbatim}
...
\subsection{Ejecución de consola de comandos}