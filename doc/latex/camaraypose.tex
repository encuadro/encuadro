...
\end{array}
\]
donde $(\tilde{u_0}',\tilde{v_0}')$ son las coordenadas reales de la proyección medidas en píxeles, $(u_0',v_0')$ son las coordenadas ideales de la proyección medidas también en píxeles y $(u_P',v_P')$ son las coordenadas del punto principal. Véase que en este caso $r=\sqrt{(u_0' - u_P')^2 +(v_0' - v_P') }$.\\
