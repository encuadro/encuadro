...
Se llama proceso de pryección al proceso en el que se asocia al punto \textbf{M} del mundo, un punto \textbf{m} en la imagen. Para modelar el mismo es necesario referirse a varias transformaciones y varios ejes de coordenadas.
\begin{itemize}
...
Una vez estimado $b$ es posible recontruir la matriz de parámetros intrínsecos I, para luego utilizando I y las homografías H obtener los parámetros extrínsecos de la cámara para cada fotografía utilizada para la calibración.\\ 
...
\section{Calibiración de cámaras utilizadas}
...
Los parámetros intrínsecos obtenidos para imágenes de $960\times720$ son:
\[
I = 
\left(\begin{array}{ccc}
1178.28066  & 0 & 410.22957 \\
0 & 1161.50785 & 331.82398 \\
0 & 0 & 1
\end{array}\right)  
\]

Para la aplicación se utilizaron imágenes de $480\times360$ que se obtuvieron de la funcionalidad de \textit{preview} del AVFoundation.  Si bien el dispositivo permite hacer \textit{preview} en este tama\~no, no es posible tomar fotos o capturar fotos. De las calibraciones anteriores se vio que entre imágenes tomadas con la misma cámara de diferentes tama\~no los parámetros intrínsecos varían según la variación del tama\~no. Por lo tanto la calibración para imágenes de $480\times360$ se tomó como los valores obtenidos para imágenes de $960\times720$ divido por dos. 
\[
I  = 
\left(\begin{array}{ccc}
589.141 & 0 &	205.115\\
