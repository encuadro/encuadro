...
\subsection{\textit{DLT}(\textit{D}irect \textit{L}inear \textit{Transform})}
...
\begin{equation*}
\begin{split}
\frac{\textbf{H}_{11}X_i+\textbf{H}_{12}Y_i+\textbf{H}_{13}Z_i+H_{14}}{\textbf{H}_{31}X_i+\textbf{H}_{32}Y_i+\textbf{H}_{33}Z_i+\textbf{H}_{34}} = x_i, \\
\\
...
\end{split}
\end{equation*}
La ecuación para $s'_i$ se puede obtener como combinación lineal de las de $x'_i$ y $y' _i$, por eso no se tiene en cuenta. 
