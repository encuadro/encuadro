...
Se desprende de la imagen \ref{fig:CalibracionCamara} y algo de trigonometría la siguiente relación entre las coordenadas en cuestión y la distancia focal (f):
\[
