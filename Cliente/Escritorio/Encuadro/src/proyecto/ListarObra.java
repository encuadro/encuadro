 ...
 * @author SysAdmin
 */
public class ListarObra extends javax.swing.JFrame {
    ProcesandoPeticion prc = new ProcesandoPeticion();
    /**
     * Creates new form ListarObra
     */
    public ListarObra() {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Listar Obras (1 de 2)");
    ...
    private void BotContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotContinuarActionPerformed
        ...
        if(seleccion == -1 || tablaSal.getValueAt(tablaSal.getSelectedRow(),0)==null){
            JOptionPane.showMessageDialog(rootPane, "Debes seleccionar una sala válida.");
        }else{
            String x = (String) tablaSal.getValueAt(tablaSal.getSelectedRow(), 0);
            Global.IdSala = Integer.parseInt(x);
            ListarObra2 mo2 = new ListarObra2();
            this.dispose();
            mo2.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarObra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarObra().setVisible(true);
            }
        });
    }
